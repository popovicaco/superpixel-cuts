...
```python
dataset_name = 'something something 2'
h5_import = h5py.File("C:/Users/apopo/Desktop/Research/Data/choroid_IMS_albino_mouse_eye/20230321/Pigmented.h5",'r+').get('Cube/resultarray/inputdata')
...
```python
chunk_sigma_param = 0.025 # 0.1 -> 0.001           #0.01
chunk_spatial_limit = 25# 15 -> 25 in steps of 5 #15
