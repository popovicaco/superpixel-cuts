...
\input{Background/Superpixel Generation/2.2 - Superpixel Generation.tex}
\subsubsection{Simple Linear Iterative Clustering} \label{SLIC}
\input{Background/Superpixel Generation/2.2.1 - Simple Linear Iterative Clustering.tex}

\clearpage
\subsection{Hyperspectral Unmixing} \label{Unmixing Intro}
\input{Background/Hyperspectral Unmixing/2.3 - Unmixing and AE.tex}
\subsubsection{Linear Mixing Model}\label{LMM}
\input{Background/Hyperspectral Unmixing/2.3.1 - Linear Mixing Model.tex}
\subsubsection{Abundance Estimation}\label{AE}
\input{Background/Hyperspectral Unmixing/2.3.2 - Abundance Estimation.tex}
\subsubsection{Alternating Direction Method of Multipliers}\label{ADMM Intro}
\input{Background/Hyperspectral Unmixing/2.3.3 - ADMM.tex}
...
\input{Background/Spectral Clustering/2.4 - Spectral Clustering.tex}
\subsubsection{Normalized Cuts} \label{Normalized Cuts}
\input{Background/Spectral Clustering/2.4.1 - Normalized Cuts.tex}
