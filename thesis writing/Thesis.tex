...
\input{Adaptive Superpixel Cuts/Preprocessing/Dataset Preprocessing.tex}
\subsubsection{Singular Value Decomposition} \label{SVD}
\input{Adaptive Superpixel Cuts/Preprocessing/SVD.tex}
\subsubsection{Layer Normalization} \label{Normalization}
\input{Adaptive Superpixel Cuts/Preprocessing/Normalization.tex}

\clearpage
\subsection{Algorithm Overview} \label{Algorithm Overview}
\input{Adaptive Superpixel Cuts/Algorithm/Algorithm Proposal.tex}
\subsubsection{Superpixel Generation} \label{Algorithm Superpixels}
\input{Adaptive Superpixel Cuts/Algorithm/Superpixel Generation.tex}
\subsubsection{Construction of the Affinity Matrix $\mathbf{W}$}\label{Algorithm Laplacian}
\input{Adaptive Superpixel Cuts/Algorithm/Affinity Matrix Construction.tex}
\subsubsection{Normalized Cuts Algorithm}\label{Algorithm Ncuts}
\input{Adaptive Superpixel Cuts/Algorithm/Normalized Cuts Algorithm.tex}
...
\input{Adaptive Superpixel Cuts/Algorithm/Feature Vector Creation.tex}
\subsubsection{Compilation}\label{Compilation}
\input{Adaptive Superpixel Cuts/Algorithm/Overall View.tex}
